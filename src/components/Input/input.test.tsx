...
describe('test Input component', () => {
  it('should render the correct default Input', () => {
    ...
    expect(testNode).toHaveClass('sui-input-inner');
  ...
  it('should render different input sizes on size property', () => {
    ...
    const testWrapper = screen.getByTestId('sui-input-wrapper-id');
    expect(testWrapper).toHaveClass('sui-input-wrapper input-size-lg');
  });
  ...
  it('should render prepand and append element on prepand/append property', () => {
    ...
    const testWrapper = screen.getByTestId('sui-input-wrapper-id');
    expect(testWrapper).toHaveClass('input-group input-group-append input-group-prepend');
